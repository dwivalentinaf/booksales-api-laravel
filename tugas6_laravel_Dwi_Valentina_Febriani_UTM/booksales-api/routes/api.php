...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::apiResource('/books', BookController::class)->only(['store', 'update', 'destroy']); //api resource
    Route::apiResource('/genres', GenresController::class)->only(['store', 'update', 'destroy']); //api resource
    Route::apiResource('/authors', AuthorController::class)->only(['store', 'update', 'destroy']); //api resource
    });
